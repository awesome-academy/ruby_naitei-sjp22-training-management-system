...
RSpec.describe Admin::AdminUsersController, type: :controller do
  ...
  describe "GET #show" do
    ...
    context "when admin is not found" do
      ...
      it "sets a danger flash message" do
        expect(flash[:danger]).to eq(I18n.t("admin.admin_users.show.user_not_found"))
      end
    end
  end
  ...
  describe "PATCH #activate" do
    context "when activation succeeds" do
      before do
        allow_any_instance_of(User).to receive(:activate).and_return(true)
  ...
  describe "PATCH #promote" do
    ...
    context "with invalid supervisor_id" do
      ...
      it "sets alert flash" do
        expect(flash[:danger]).to eq(I18n.t("admin.admin_users.promote.user_not_found"))
      end
    end
