...
RSpec.describe Supervisor::SubjectsController do
  ...
  describe "GET #index" do
    ...
    context "with search params" do
      ...
      it "filters subjects based on search query" do
        expect(assigns(:subjects)).to contain_exactly(subject_alpha)
      end
    end
    ...
    context "with valid pagination params" do
      ...
      let(:page) {2}
      let!(:more_subjects) {create_list(:subject, 25)}
      ...
      it "assigns the correct page of items" do
        ...
        expect(assigns(:subjects)).to eq(expected_paginated_subjects)
      end
    end
  end
